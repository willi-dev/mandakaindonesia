			...
			<div class="panel-body">
				...
				<div class="adv-table">
					<table  class="display table table-bordered table-striped table-condesed" id="tableproduk">
						...
						<?php 
							$no=1;
							foreach($loadProduct as $lp){ //$shortdesc = SUBSTR("$lp->produk_deskripsi", 0, 40);
							?>
							<tr>
								<td><?php echo $no;?></td>
							...
							<div aria-hidden="true" aria-labelledby="hapusproduk<?php echo $lp->id;?>Label" role="dialog" tabindex="-1" id="hapusproduk<?php echo $lp->id;?>" class="modal fade">
							  <div class="modal-dialog">
								  <div class="modal-content">
									  <div class="modal-header">
										  <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
										  <h4 class="modal-title">Hapus Produk : <?php echo $lp->produk_nama;?></h4>
									  </div>
									  <div class="modal-body">
											<div class="col-sm-12">
												<h3>Yakin ingin menghapus Produk <?php echo $lp->produk_nama;?> ? </h3><br /> 
												<h4>Ini akan menghapus data produk berikut foto-fotonya.. </h4>
											</div>
									  </div>
									  <div class="modal-footer">
										<a href="<?php echo base_url();?>administrator/produk_hapus/<?php echo $lp->id;?>">
