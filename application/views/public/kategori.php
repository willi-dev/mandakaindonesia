...
?>
	<div id="content" class="span-18 last">
		...
		<?php
		if(isset($loadAllProductCategory)){
			$no=1;
			
			foreach($loadAllProductCategory as $lap){
			if($no%3==0){
				$last = "last";
			}else{
				$last = "";
				...
				<div class="wrap-product-inner span-6 <?php echo $last;?>">
					<?php if($lap->foto!=NULL){ ?>
						<div class="wrap-grid-img">
							<img src="<?php echo base_url();?>uploads/produk/thumb/<?php echo $lap->foto;?>" alt=""  width="200px" class="img-product" />
						</div>
					<?php }else{ ?>
						<div class="wrap-grid-img">
							<img src="<?php echo base_url();?>assets/public/img/tumblr-logo.png" alt="" width="200px" class="img-product" />
						</div>
					<?php }?>
				</div>
